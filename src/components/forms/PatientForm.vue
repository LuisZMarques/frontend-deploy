              ...
              <v-window-item :value="indexDispositivo">
                <div v-if="tab !== 'patient'">
                  <v-row>
                    ...
                    <v-col :cols="smAndDown ? '12' : '4'">
                      <v-text-field label="Start Date" placeholder="yyyy-mm-dd" color="primary" v-model="patient.dispositivos[indexDispositivo].data_fim" />
                    </v-col>
                    <v-col :cols="smAndDown ? '12' : '4'">
                      <v-text-field label="End Date" placeholder="yyyy-mm-dd" color="primary" v-model="patient.dispositivos[indexDispositivo].data_inicio" />
                    </v-col>
                  </v-row>
...
import { isBefore, isValid, nextDay } from 'date-fns'
